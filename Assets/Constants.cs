...
namespace Constants
{
    public static class Constants
    {
        ...
        public const string TrialsLoadedPath = "Assets/TrialsToLoad/generated_trials_eval_soccer_niall_0.json";
        public const string DataOutputFileName = "gaze_data_eval_soccer_niall_0";
